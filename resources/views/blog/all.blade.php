...
?>
 ...
 <!-- Breadcrumb End -->
<input type="hidden" id="idMinViewMoreBlog" value="{{ $idMin }}">
 <!-- Blog Section Begin -->
 <section class="blog spad">
     <div class="container">
         <div id="row-all-blog" class="row">
             ...
             @if($count > 12)
             <div class="col-lg-12 text-center box-tag-a-view-more-blog">
...
<script src="{{ asset('users/js/blogs.js') }}"></script>
 @endsection

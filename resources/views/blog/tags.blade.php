...
<section class="blog spad">
    <div class="container">
        <div class="row pb-4">
            <div class="col-lg-12">
                <div class="h3">Tag: {{ $datatag->nameTagBlog }}</div>
            </div>
        </div>
        <div id="row-all-blog-by-tag" class="row">
            <!--  -->
            ...
            @if($count > 12)
            <div class="col-lg-12 text-center box-tag-a-view-more-blog-by-tag">
                <a href="#" data-tag="{{ $datatag->id }}" data-id="{{ $idMin }}" class="primary-btn load-btn a-btn-view-more-blog-by-tag">Xem thêm {{ $remaining }} bài viết</a>
            </div>
            @endif
...
<script src="{{ asset('users/js/blog-by-tag.js') }}"></script>
@endsection

            ...
            <div class="deal-leftmk left-side">
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="users/images/s4.jpg" alt="">
                    </div>
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="users/images/s2.jpg" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="users/images/s1.jpg" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                        <h3>Bella Toes</h3>
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="users/images/s5.jpg" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                        <h3>Red Bellies</h3>
                ...
                <div class="special-sec1">
                    <div class="col-xs-4 img-deals">
                        <img src="users/images/s3.jpg" alt="">
                    </div>
                    <div class="col-xs-8 img-deal1">
                        <h3>(SRV) Sneakers</h3>
        ...
        <div class="left-ads-display col-md-9">
            <div class="wrapper_top_shop">
                <div class="col-md-6 shop_left">
                    <img src="users/images/banner3.jpg" alt="">
                    <h6>40% off</h6>
                </div>
                <div class="col-md-6 shop_right">
                    <img src="users/images/banner2.jpg" alt="">
                    <h6>50% off</h6>
                </div>
                <div class="clearfix"></div>
                <!-- product-sec1 -->
                                ...
                                <div class="men-thumb-item">
                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="/products/{{$item['slug']}}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 shop_left shp">
                    <img src="users/images/banner4.jpg" alt="">
                    <h6>21% off</h6>
                </div>
                <div class="col-md-6 shop_right shp">
                    <img src="users/images/banner1.jpg" alt="">
                    <h6>31% off</h6>
                </div>
                <div class="clearfix"></div>
            </div>

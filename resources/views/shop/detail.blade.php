...
<style>
  ...
  /* range prive */
                            ...
                            <div class="size__list">
                                ...
                                @foreach ($categories as $cate)
                                    ...
                                    <label for="cate-{{$cate['id']}}">
                                        ...
                                        <input type="checkbox" id="cate-{{$cate['id']}}" class="idCate" name="idCate" <?php echo $slug==$cate['slug'] ? 'checked' : ''?> value="{{$cate['id']}}">
    ...
    <script src="{{ asset('users/js/shopDetail.js') }}"></script>
    <!-- Shop Section End -->
@endsection